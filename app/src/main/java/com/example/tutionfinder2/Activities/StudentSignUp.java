    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(StudentSignUp.this,"Please fill all credential",Toast.LENGTH_LONG).show();
                }
                else if(!passwordTXT.equals(confirmPassTXT))
                {
                    Toast.makeText(StudentSignUp.this,"Password not matching!!",Toast.LENGTH_LONG).show();
                }
                else
                {
                    ...
                    databaseReference.child("Registered_User").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            {
                                Toast.makeText(StudentSignUp.this,"The Phone Number is already registered",Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                ...
                                Toast.makeText(StudentSignUp.this,"User Register Successfully",Toast.LENGTH_SHORT).show();
                                finish();
                            }
